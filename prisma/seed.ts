...
async function main() {
  ...
  const controls = [
    ...
    { id: 'ctrl-008', controlRef: 'AML-008', name: 'Blockchain Analytics Integration', description: 'Integration with blockchain analytics tools (e.g., Chainalysis, Elliptic) for cryptoasset tracing and risk scoring.', categoryId: 'cat-aml', fcaPrincipleId: 'fca-p3', status: ControlStatus.PARTIALLY_COMPLIANT, ownerId: complianceOfficer.id, lastReviewed: new Date('2024-03-15'), nextReviewDate: new Date('2024-09-15') },
